    ...
    <div class="w-full mx-auto p-4 flex">
      ...
      <div class="w-1/4 p-4">
        <div class="overflow-x-hidden">
          <label for="document" class="mb-2 block text-xl text-gray-800">Document</label>
          <a :href="currentFileUrl" download target="_blank" v-if="currentFile"
          ...
          <div v-else class="mt-4 bg-gray-500 text-white p-2 w-full rounded-lg text-center">
